...
{
    public class Dieux : Personnage
    {
        private int avantage;
        private int désavantage;

        public Dieux(int PointsDeVie, int Force, string Nom, int Dégats, int avantage, int désavantage) : base(PointsDeVie, Force, Nom, Dégats)
        {
